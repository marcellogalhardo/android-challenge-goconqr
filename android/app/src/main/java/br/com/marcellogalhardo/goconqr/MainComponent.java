...
import br.com.marcellogalhardo.goconqr.util.UtilModule;
import dagger.Component;

@Singleton
@Component(modules = {ApplicationModule.class, NetworkModule.class, EventListModule.class,
        AddEventModule.class, EventStoreModule.class, NetworkModule.class, UtilModule.class})
